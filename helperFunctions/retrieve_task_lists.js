...
async function updateLocalTaskLists() {
	try {
        ...
        console.error('Failed to update local task lists');
	}
}
...
async function getSpaces() {
    ...
    try {
        ...
        console.error('Error fetching spaces from ClickUp:');
        throw error;
    }
}
...
async function getFolderlessLists(spaceId) {
    ...
    try {
        ...
        console.error(`Error in getFolderlessLists for space ID ${spaceId}:`);
        throw error;
    }
}
...
async function getFolders(spaceId) {
    ...
    try {
        ...
        console.error('Error fetching folders from ClickUp:');
        throw error;
    }
}
...
async function getLists(folderId) {
    ...
    try {
        ...
        console.error('Error fetching lists from ClickUp:');
        throw error;
    }
}
